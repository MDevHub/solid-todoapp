  ...
  const navigate = useNavigate();
   ...
   return (
      <div class="flex flex-col gap-4 text-(--light-text)">
         ...
         <div
            onClick={() => {
               props.setCurrentPage?.("inbox");
               props.setOpen?.(false);
            }}
            class="flex items-center gap-4 p-3 rounded-xl hover:bg-[rgba(255,255,255,0.05)] cursor-pointer transition-colors"
            >
            <Inbox size={18} />
         ...
         <div
            onClick={() => {
               props.setCurrentPage?.("completed");
               props.setOpen?.(false);
            }}
            class="flex items-center gap-4 p-3 rounded-xl hover:bg-[rgba(255,255,255,0.05)] cursor-pointer transition-colors"
            >
